...
typedef struct manager_tt{
  ...
  int* partial_order; //array of partial order "score". High score means high preference.
                      //Scores in this array have higher priority than those in the 'score' array.
#endif
...
void reduce_kb();
char add_base_clause(my_clause*); //added 10/11/07
...
void* double_array_len(void*,int*,size_t);
